...
def transform_data_nb_nuitees(df_nb_nuitees) :
    """
...
def creation_dataframe_affluences(df_capacite, df_nb_nuitees) :
    """
...
if __name__ == "__main__" :
    ...
    df_nb_nuitees = transform_data_nb_nuitees(df_nb_nuitees)

    print(df_nb_nuitees.head())

    df_affluences = creation_dataframe_affluences(df_capacite, df_nb_nuitees)
